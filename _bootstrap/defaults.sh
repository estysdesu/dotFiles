...
defaults write NSGlobalDomain AppleMeasurementUnits -string "Centimeter"
...
# Sleep the display after 5 minutes (set to 0 to disable)
sudo pmset -a displaysleep 5

# Sleep after 15 minutes while charging (set to 0 to disable)
